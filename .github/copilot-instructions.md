...
## Development machines and documentation location

I develop on two computers: one Windows and one Linux. Project documentation
lives outside this repo, in an Obsidian vault, and the path depends on which
machine is in use.
